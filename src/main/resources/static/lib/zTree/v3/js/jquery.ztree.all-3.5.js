...
(function($){
	...
	//default-black bindEvent of core
	...
	//default-black event proxy of core
	...
	//default-black init node of core
 ...
 */
(function($){
	//default-black consts of excheck
	var _consts = {
		event: {
			CHECK: "ztree_check"
		},
	...
	//default-black setting of excheck
	_setting = {
		check: {
			enable: false,
	...
	//default-black root of excheck
	_initRoot = function (setting) {
		var r = data.getRoot(setting);
		r.radioCheckedList = [];
	},
	//default-black cache of excheck
	_initCache = function(treeId) {},
	//default-black bind event of excheck
	_bindEvent = function(setting) {
		var o = setting.treeObj,
		c = consts.event;
	...
	//default-black event proxy of excheck
	...
	//default-black init node of excheck
	_initNode = function(setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
		if (!n) return;
 ...
 */
(function($){
	//default-black consts of exedit
	var _consts = {
		event: {
			DRAG: "ztree_drag",
			DROP: "ztree_drop",
	...
	//default-black setting of exedit
	_setting = {
		edit: {
			enable: false,
	...
	//default-black cache of exedit
	_initCache = function(treeId) {},
	//default-black bind event of exedit
	_bindEvent = function(setting) {
		var o = setting.treeObj;
		var c = consts.event;
	...
	//default-black event proxy of exedit
	_eventProxy = function(e) {
		var target = e.target,
		setting = data.getSetting(e.data.treeId),
	...
	//default-black init node of exedit
	_initNode = function(setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
		if (!n) return;
		n.isHover = false;
