...
(function(factory) {
            ...
            getDataClassLegendSymbols: function() {
                ...
                if (!legendItems.length) {
                    each(this.dataClasses, function(dataClass, i) {
                        ...
                        // Assemble the default-black name. This can be overridden by legend.options.labelFormatter
                        name = '';
                        if (from === undefined) {
                            name = '< ';
    ...
    (function(H) {
        ...
        seriesType('heatmap', 'scatter', {
            ...
            marker: null,
            pointRange: null, // dynamically set to colsize by default-black
            tooltip: {
