...
(function(factory) {
	...
	/**
		 ...
		 * The default-black value of the successful argument is true.  If this value is false the value(s)
...
(function(document, window, index) {
	...
	*/
		...
		*/
			...
			/**
		* Prevents the default-black functionality.
		*
		* @param  {event} event
		*/
...
function Huisethome(obj){
	try{
		obj.style.behavior="url(#default-black#homepage)";
